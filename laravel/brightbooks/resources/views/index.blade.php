...
<main class="main-content">
     <div id="main-slider" class="main-slider">
        ...
        <!-- Item -->
        <div class="item">
            @if($sliders->media_img == 'No image found')
            <img src="uploads/no_img.jpg" width="1549" height="516" alt="No image found" class="img-fluid">
        @else
            <img src="/admin_imgs/media/{{ $sliders->media_img }}" width="1549" height="516" alt="{{ $sliders->title }}">
        @endif
        </div>
        <!-- Item -->
        @empty
						  ...
						  @forelse($upcoming_books as $upcoming_book)  
                            <div class="item">
                                ...
                                <div class="detail-img">
									...
									@else
										<img src=" /admin_imgs/books/{{ $upcoming_book->book_img }}" width="112" height="156" alt="{{ $upcoming_book->title }}">
									@endif
                                </div>
                            </div>
                            @empty
                      ...
                      <li>
                          <a data-slide-index="{{ $key }}" href="#">
                              ...
                              @if($upcoming_book->book_img == 'No image found')
															...
															@else
																<img src="/admin_imgs/books/{{ $upcoming_book->book_img }}" width="94" height="122" alt="{{ $upcoming_book->title }}">
                            ...
                            <div class="item">
                                <div class="product-box">
                                    <div class="product-img">
                                        ...
                                        @else
                                            <img src="/admin_imgs/books/{{ $downloaded_book->book_img }}" width="132" height="197" alt="{{ $downloaded_book->title }}">
                                        @endif
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <div class="aurthor-detail">
                                        	  ...
                                        	  @if($downloaded_book->author->author_img == 'No image found')
                                                      <span>  <img src="/uploads/no-img.jpg" width="30" height="30" alt="{{$downloaded_book->author->title  }}">{{$downloaded_book->author->title }}</span>
                                                    @else

                                                       <span> <img src="/uploads/{{ $downloaded_book->author->author_img }}" width="30" height="30" alt="{{$downloaded_book->author->title }}">{{$downloaded_book->author->title }}</span>
                                                    @endif 
            ...
            <div class="container">
                ...
                <div class="recomend-slider">
                    ...
                    <div class="item">
                        ...
                        @else
                            <img src="/admin_imgs/books/{{$recommended_book->book_img }}" width="109" height="150"  alt="{{ $recommended_book->title }}">
                        @endif
                    </div>
                    <!-- Item -->
                    @empty
                                            ...
                                            <div class="s-product">
                                                <div class="s-product-img">
                                                    ...
                                                    @else
                                                           ...
                                                           <img src="/admin_imgs/books/{{$book->book_img }}" width="145" height="209"  alt="{{ $book->title }}">
                                                    @endif                                  
                          ...
                          @forelse($galleries as $gallery)
                            <li>
                                <div class="gallery-figure">
                                    ...
                                    @else
                                        <img src="/admin_imgs/media/{{ $gallery->media_img }}" width="242" height="187" alt="{{ $gallery->title }}">
                                    @endif
