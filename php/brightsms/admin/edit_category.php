...
<?php
  require 'config/dbc.php';
  $id = $_GET['id'];
  $query = mysqli_query($connection, "SELECT * FROM category WHERE id=$id") or die(mysqli_error());
...
<div class="page-container row-fluid">
    ...
    <div class="content">
        ...
        <form id="formEdit" name="formEdit" method="POST"  action="<?php echo $_SERVER['PHP_SELF'];?>">
