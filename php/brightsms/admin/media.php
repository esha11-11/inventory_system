                    ...
                    <br>
                       <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                           ...
                           $query = mysqli_query($connection, "SELECT * FROM media") or die(mysqli_error());
                            ...
                            <tr>
                                ...
                                <td><img src="../uploads/<?php echo $row['media_img']; ?>" width="60" height="60" class="img-thumbnail" alt="<?php echo $row['title']; ?>"></td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <a href="delete_media.php?id=<?php echo $row['id'];?>" onclick="return confirm('Are u sure u want to Delete this record?')"  class="label label-important "> <i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                              <?php }?>
                        </tbody>
